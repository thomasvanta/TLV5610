/*
  ...
  Wiring:
    ...
    Based on the TLV5610 library by:
  2012-09-29 @machinesalem,  (cc) https://creativecommons.org/licenses/by/3.0/
  Addapted to TLV5610 bby Thomas Van Ta on 18. August 2015
*/
...
#define TLV5610_SPEED_SLOW  0x00
#define TLV5610_SPEED_FAST  0x40
#define TLV5610_POWER_NORM  0x00
#define TLV5610_POWER_DOWN  0x20

/* Raw commands */
/* Write the value to channel B and to the buffer */
#define TLV5610_CMD_WRITE_B_AND_BUFFER 0x00
/* Write the value to the buffer only */
#define TLV5610_CMD_WRITE_BUFFER       0x10
/* Write the value to channel A, and update channel B from the buffer */
#define TLV5610_CMD_WRITE_A_UPDATE_B   0x80
...
class TLV5610
{
  ...
  public:
    TLV5610( uint8_t cs_pin );
    TLV5610( uint8_t cs_pin, uint8_t control );
